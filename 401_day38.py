...
# Extract details from HTML form
...
def submit_form(form_details, url, value):
    # Target url to create javascript data payload and see its changes in response content
...
# XSS scan on url
def scan_xss(url):
    # Idenifies all forms on the url and outputs the findings
...
# User input for a URL target to test XSS and scans 
