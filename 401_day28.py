...
def desktop_wallpaper(image_ransom, message_ransom):
    ...
    path = '/home/divermedic/401d8-code/image-background.jpg' 
...
# popup window with ransomware message
    messagebox.showinfo("This is the ransomeware pop-up window, /n In order to decrypt follow the instruction... (pending) ", message_ransom)
